        ...
        <div class="main-left lg:col-span-6 md:col-span-5 space-y-2 sm:col-span-7 col-span-12 sm:order-2 order-3">
            <div class="bg-white border border-gray-200 rounded-lg">
                ...
                <div class="p-4 border-t border-gray-100 flex justify-between">
                    <a href="#" class="inline-block sm:py-3 py-2 sm:px-6 px-4 bg-gray-600 text-white rounded">Attach
                        image</a>

                    <a href="#" class="inline-block sm:py-3 py-2 sm:px-6 px-4 bg-purple-600 text-white rounded">Post</a>
                </div>
            </div>
