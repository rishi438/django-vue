<template>
    <div class="max-w-7xl mx-auto grid grid-cols-12 gap-2">
        ...
        <div class="main-center lg:col-span-6 md:col-span-5 space-y-2 sm:col-span-7 col-span-12 sm:order-2 order-3">
            <div v-if="friend_requests.length" class="p-4 bg-white border border-gray-200 rounded-lg gap-2">
                <hr />
                <h2 class="text-xl mb-6">Friend Requests</h2>
                <div class="p-4 text-center bg-gray-100 rounded-lg" v-for="friend in friend_requests"
                    v-bind:key="friend.id">
                    <div class="text-center">
                        <img src="../assets/1639256761455.jpeg" class="mb-6 rounded-full w-[180px] h-[180px] mx-auto" />
                        <p>
                            <strong>
                                <RouterLink :to="{ name: 'profile', params: { id: friend.created_by.id } }">{{
                                    friend.created_by.name
                                }}</RouterLink>
                            </strong>
                        </p>
                    </div>
                    ...
                    <div class="mt-6">
                        <button class="inline-block py-2 sm:px-6 px-4 bg-lime-600 text-white rounded mx-2"
                            @click="handler_request('ACCEPTED', friend.created_by.id)">
                            Accept
                        </button>
                        <button class="inline-block py-2 sm:px-6 px-4 bg-red-700 text-white rounded mx-2"
            ...
            <div v-if="friends.length" class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-2 gap-2">
                <div class="text-center bg-gray-100 rounded-lg py-5" v-for="friend in friends" v-bind:key="friend.id">
                    <div class="text-center">
                        <img src="../assets/1639256761455.jpeg" class="mb-6 rounded-full w-[150px] h-[150px] mx-auto" />
                        <p>
                            <strong>
