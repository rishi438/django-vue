    ...
    <div class="main-left md:col-span-3 col-span-12 order-1">
      <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
        ...
        <div class="flex flex-col">
          <button class="mt-6 flex-auto py-2 sm:px-6 px-4 bg-cyan-500 text-white rounded"
            v-if="userStore.user.id != user.id" @click="send_friend_request">
            Add friend
          </button>
          <button class="mt-3 flex-auto py-2 sm:px-6 px-4 bg-cyan-500 text-white rounded"
            v-if="userStore.user.id != user.id" @click="send_message">
            Message
          </button>
        </div>
      </div>
