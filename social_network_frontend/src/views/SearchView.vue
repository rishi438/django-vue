    ...
    <div class="main-center md:col-span-3 col-span-4 space-y-4">
      <div class="bg-white border border-gray-200 rounded-lg">
        <form v-on:submit.prevent="submit_form" class="p-6 flex space-x-4">
          <input v-model="query" type="search" class="p-3 w-full bg-gray-100 rounded-lg"
      ...
      <div v-if="users.length"
        ...
        <div class="p-4 text-center bg-gray-100 rounded-lg" v-for="user in users" v-bind:key="user.id">
          <div class="text-center">
            <img src="../assets/1639256761455.jpeg" class="mb-6 rounded-full w-[130px] h-[130px] mx-auto" />
            <p>
              <strong>
