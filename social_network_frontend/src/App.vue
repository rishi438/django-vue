        ...
        <div class="max-w-screen-2xl mx-auto">
            <div class="flex items-center justify-between">
                ...
                >
                    <RouterLink
                        :to="{ name: 'home' }"
                        :class="{ 'text-teal-500': route_name === 'home' }"
                    >
                        <svg
                    ...
                    <RouterLink
                        :to="{ name: 'messenger' }"
                        :class="{ 'text-teal-500': route_name === 'messenger' }"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                    ...
                    <RouterLink
                        ...
                        :class="{ 'text-teal-500': route_name === 'notification' }"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                    ...
                    <RouterLink
                        :to="{ name: 'search' }"
                        :class="{ 'text-teal-500': route_name === 'search' }"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
