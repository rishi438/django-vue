  ...
  <nav class="py-4 px-8 border-b border-gray-200">
    <div class="max-w-screen-2xl mx-auto">
      <div class="flex items-center justify-between">
        <div class="menu-left">
          <RouterLink :to="{name:''}" class="text-xl">Network</RouterLink>
        </div>
        <div
        ...
        >
          <RouterLink :to="{name:'home'}" :class="{ 'text-teal-500': route_name === 'home' }">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-6 h-6 hover:text-teal-400"
            >
              <path
          ...
          <RouterLink :to="{name:'messenger'}" :class="{ 'text-teal-500': route_name === 'messenger' }">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <RouterLink :to="{name:'notification'}" :class="{ 'text-teal-500': route_name === 'notification' }">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <RouterLink :to="{name:'search'}" :class="{ 'text-teal-500': route_name === 'search' }">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div class="menu-right">
          ...
          <div class="my-3" v-else>
            <RouterLink
              :to="{ name: 'login' }"
              class="py-3 px-6 bg-teal-500 hover:bg-teal-600 text-white rounded-lg mx-1"
              >Log in
            </RouterLink>
            <RouterLink
              :to="{ name: 'signup' }"
              class="py-3 px-6 bg-zinc-500 hover:bg-zinc-600 text-white rounded-lg mx-1"
              >sign up
            </RouterLink>
          </div>
        </div>
